...
# RUN echo ':CocInstall coc-json coc-tsserver coc-html coc-css' > /home/developer/.vim/vim-init.txt
# RUN echo ':qall' >> /home/developer/.vim/vim-init.txt
# RUN echo "yuhuhu"
# RUN vim -s /home/developer/.vim/vim-init.txt /home/developer/dummy-file
# RUN cd /home/developer/.config/coc/extensions/ && npm install
...
# Vim Plugin JS File Import 
#RUN git clone https://github.com/kristijanhusak/vim-js-file-import /home/developer/.vim/pack/plugins/start/vim-js-file-import
